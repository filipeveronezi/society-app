...
export default {
  ...
  methods: {
    ...
    async createCourt() {
      ...
      const res = await fetch("http://society.filipeveronezi.dev.br:3000/courts", {
      ...
      if (res.status == 200) {
        const second_res = await fetch("http://society.filipeveronezi.dev.br:3000/courts/" + id + "/addresses", {
    ...
    async updateCourt() {
      ...
      const res = await fetch("http://society.filipeveronezi.dev.br:3000/courts/" + court_id, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json"
        },
      ...
      if (res.status == 200) {
        const second_res = await fetch("http://society.filipeveronezi.dev.br:3000/courts/" + court_id + "/addresses", {
          method: "PUT",
          headers: {
            "Content-Type": "application/json"
          },
